...
sum_regret_sample = [x / no_of_samples for x in sum_regret_sample]
plt.plot(sum_time,sum_regret_sample)
plt.xlabel('Time') 
plt.ylabel('Regret') 
#   plt.title('regret-time graph') 
...
with open('regret_average_random.pkl', 'wb') as handle:
    pickle.dump(sum_regret_sample, handle)

with open('regret_average_random.pkl', 'rb') as handle:
...
with open('sum_timefile2.pkl', 'wb') as handle:
    pickle.dump(sum_time, handle)

# with open('sum_timefile.pkl', 'rb') as handle:
#     b = pickle.load(handle)
...
sum_regret_sample2 = [x / no_of_samples for x in b]
plt.plot(sum_time,sum_regret_sample2)
plt.xlabel('Time') 
plt.ylabel('Regret') 
#   plt.title('regret-time graph') 
